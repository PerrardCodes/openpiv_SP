...
# Build extensions 
module1 = Extension(    name         = "openpiv_SP.process",
                        sources      = ["openpiv_SP/src/process.pyx"],
                        include_dirs = [numpy.get_include()],
                    )
                    
module2 = Extension(    name         = "openpiv_SP.lib",
                        sources      = ["openpiv_SP/src/lib.pyx"],
                        include_dirs = [numpy.get_include()],
                    )
...
data_files = [ ('openpiv_SP/examples/tutorial-part1', glob.glob('openpiv/examples/tutorial-part1/*') ),
               ('openpiv_SP/examples/masking_tutorial', glob.glob('openpiv/examples/masking_tutorial/*') ),
               ('openpiv_SP/docs/openpiv/examples/example1', glob.glob('openpiv/docs/examples/example1/*') ),
               ('openpiv_SP/docs/openpiv/examples/gurney-flap', glob.glob('openpiv/docs/examples/gurney-flap/*') ),
               ('openpiv_SP/docs/openpiv', ['README.md'] ),
               ('openpiv_SP/data/ui', glob.glob('openpiv/data/ui/*.ui') ),
             ]


# packages that we want to distribute. THis is how
# we have divided the openpiv package.
packages = ['openpiv_SP', 'openpiv_SP.ui']

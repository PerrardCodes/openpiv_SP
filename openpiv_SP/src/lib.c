...
#define __PYX_HAVE__openpiv_SP__lib
#define __PYX_HAVE_API__openpiv_SP__lib
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 */
typedef __pyx_t_5numpy_float_t __pyx_t_10openpiv_SP_3lib_DTYPEf_t;

/* "openpiv_SP/src/lib.pyx":10
 * ctypedef np.float_t DTYPEf_t
 * DTYPEi = np.int
 * ctypedef np.int_t DTYPEi_t             # <<<<<<<<<<<<<<
 * 
 * 
 */
typedef __pyx_t_5numpy_int_t __pyx_t_10openpiv_SP_3lib_DTYPEi_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'openpiv_SP.lib' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEf_t = { "DTYPEf_t", NULL, sizeof(__pyx_t_10openpiv_SP_3lib_DTYPEf_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t = { "DTYPEi_t", NULL, sizeof(__pyx_t_10openpiv_SP_3lib_DTYPEi_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_10openpiv_SP_3lib_DTYPEi_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_10openpiv_SP_3lib_DTYPEi_t), 0 };
#define __Pyx_MODULE_NAME "openpiv_SP.lib"
extern int __pyx_module_is_main_openpiv_SP__lib;
int __pyx_module_is_main_openpiv_SP__lib = 0;

/* Implementation of 'openpiv_SP.lib' */
...
static const char __pyx_k_inans[] = "inans";
static const char __pyx_k_isnan[] = "isnan";
static const char __pyx_k_jnans[] = "jnans";
...
static const char __pyx_k_n_nans[] = "n_nans";
...
static const char __pyx_k_localmean[] = "localmean";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_iter_seeds[] = "iter_seeds";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_kernel_size[] = "kernel_size";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_replace_nans[] = "replace_nans";
static const char __pyx_k_replaced_new[] = "replaced_new";
static const char __pyx_k_replaced_old[] = "replaced_old";
static const char __pyx_k_openpiv_SP_lib[] = "openpiv_SP.lib";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_openpiv_SP_src_lib_pyx[] = "openpiv_SP/src/lib.pyx";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_A_module_for_various_utilities_a[] = "A module for various utilities and helper functions";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_method_not_valid_Should_be_one_o[] = "method not valid. Should be one of `localmean`, `disk` or `distance`.";
...
static PyObject *__pyx_n_s_inans;
static PyObject *__pyx_n_s_int;
static PyObject *__pyx_n_s_isnan;
static PyObject *__pyx_n_s_it;
static PyObject *__pyx_n_s_iter_seeds;
static PyObject *__pyx_n_s_j;
static PyObject *__pyx_n_s_jnans;
...
static PyObject *__pyx_n_s_n_nans;
...
static PyObject *__pyx_n_s_openpiv_SP_lib;
static PyObject *__pyx_kp_s_openpiv_SP_src_lib_pyx;
static PyObject *__pyx_n_s_range;
static PyObject *__pyx_n_s_replace_nans;
static PyObject *__pyx_n_s_replaced_new;
static PyObject *__pyx_n_s_replaced_old;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_s_tol;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_x;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_10openpiv_SP_3lib_replace_nans(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_array, int __pyx_v_max_iter, float __pyx_v_tol, int __pyx_v_kernel_size, PyObject *__pyx_v_method); /* proto */
...
static PyObject *__pyx_pw_10openpiv_SP_3lib_1replace_nans(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("replace_nans (wrapper)", 0);
  {
    ...
    values[4] = ((PyObject*)__pyx_n_s_disk);
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, 2); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "replace_nans") < 0)) __PYX_ERR(0, 15, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_max_iter = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_max_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_tol = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_tol == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_kernel_size = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_kernel_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    } else {
      __pyx_v_kernel_size = ((int)2);
    }
    __pyx_v_method = ((PyObject*)values[4]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("replace_nans", 0, 3, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("openpiv_SP.lib.replace_nans", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_array), __pyx_ptype_5numpy_ndarray, 1, "array", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_method), (&PyString_Type), 1, "method", 1))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_r = __pyx_pf_10openpiv_SP_3lib_replace_nans(__pyx_self, __pyx_v_array, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_kernel_size, __pyx_v_method);
...
static PyObject *__pyx_pf_10openpiv_SP_3lib_replace_nans(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_array, int __pyx_v_max_iter, float __pyx_v_tol, int __pyx_v_kernel_size, PyObject *__pyx_v_method) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_I;
  int __pyx_v_J;
  ...
  CYTHON_UNUSED PyArrayObject *__pyx_v_iter_seeds = 0;
  Py_ssize_t __pyx_v_n_nans;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_iter_seeds;
  __Pyx_Buffer __pyx_pybuffer_iter_seeds;
  ...
  __pyx_t_10openpiv_SP_3lib_DTYPEf_t __pyx_t_60;
  ...
  __pyx_pybuffer_iter_seeds.pybuffer.buf = NULL;
  __pyx_pybuffer_iter_seeds.refcount = 0;
  __pyx_pybuffernd_iter_seeds.data = NULL;
  __pyx_pybuffernd_iter_seeds.rcbuffer = &__pyx_pybuffer_iter_seeds;
  ...
  __pyx_pybuffernd_array.rcbuffer = &__pyx_pybuffer_array;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_array.rcbuffer->pybuffer, (PyObject*)__pyx_v_array, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 15, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_long(((2 * __pyx_v_kernel_size) + 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_long(((2 * __pyx_v_kernel_size) + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 81, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_kernel.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t(((__pyx_v_array->dimensions[0]) * (__pyx_v_array->dimensions[1]))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_DTYPEi); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_inans.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_6 = 0;
  __pyx_v_inans = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "openpiv_SP/src/lib.pyx":84
 * 
 *     cdef np.ndarray[DTYPEi_t, ndim=1] inans = np.empty([array.shape[0]*array.shape[1]], dtype=DTYPEi)
 *     cdef np.ndarray[DTYPEi_t, ndim=1] jnans = np.empty([array.shape[0]*array.shape[1]], dtype=DTYPEi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t(((__pyx_v_array->dimensions[0]) * (__pyx_v_array->dimensions[1]))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_DTYPEi); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_max_iter); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_DTYPEi); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_iter_seeds.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_iter_seeds = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_iter_seeds.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 86, __pyx_L1_error)
    } else {__pyx_pybuffernd_iter_seeds.diminfo[0].strides = __pyx_pybuffernd_iter_seeds.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_iter_seeds.diminfo[0].shape = __pyx_pybuffernd_iter_seeds.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_8 = 0;
  __pyx_v_iter_seeds = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "openpiv_SP/src/lib.pyx":89
 * 
 *     # indices where array is NaN
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_nonzero); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_n_s_np); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_isnan); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 89, __pyx_L1_error)
  ...
  __pyx_t_2 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_10, __pyx_t_9, ((PyObject *)__pyx_v_array)) : __Pyx_PyObject_CallOneArg(__pyx_t_10, ((PyObject *)__pyx_v_array));
  ...
  __pyx_t_4 = (__pyx_t_10) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_10, __pyx_t_2) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_2);
  ...
  if (likely(PyList_CheckExact(__pyx_t_4)) || PyTuple_CheckExact(__pyx_t_4)) {
    ...
    __pyx_t_11 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_12 = Py_TYPE(__pyx_t_1)->tp_iternext; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 89, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  for (;;) {
    if (likely(!__pyx_t_12)) {
      if (likely(PyList_CheckExact(__pyx_t_1))) {
        ...
        __pyx_t_4 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_11); __Pyx_INCREF(__pyx_t_4); __pyx_t_11++; if (unlikely(0 < 0)) __PYX_ERR(0, 89, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_11); __pyx_t_11++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
      } else {
        if (__pyx_t_11 >= PyTuple_GET_SIZE(__pyx_t_1)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_4 = PyTuple_GET_ITEM(__pyx_t_1, __pyx_t_11); __Pyx_INCREF(__pyx_t_4); __pyx_t_11++; if (unlikely(0 < 0)) __PYX_ERR(0, 89, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_11); __pyx_t_11++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
    ...
    __pyx_t_4 = 0;
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_x, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_GetModuleGlobalName(__pyx_t_10, __pyx_n_s_DTYPEi); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_9 = NULL;
    ...
    __pyx_t_4 = (__pyx_t_9) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_9, __pyx_t_10) : __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_10);
    __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 89, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_t_13 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_inans.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_13 < 0)) {
      PyErr_Fetch(&__pyx_t_14, &__pyx_t_15, &__pyx_t_16);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_inans.rcbuffer->pybuffer, (PyObject*)__pyx_v_inans, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_6 = 0;
  __Pyx_DECREF_SET(__pyx_v_inans, ((PyArrayObject *)__pyx_t_1));
  __pyx_t_1 = 0;
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_4);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer);
    __pyx_t_13 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_13 < 0)) {
      PyErr_Fetch(&__pyx_t_16, &__pyx_t_15, &__pyx_t_14);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer, (PyObject*)__pyx_v_jnans, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEi_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_7 = 0;
  __Pyx_DECREF_SET(__pyx_v_jnans, ((PyArrayObject *)__pyx_t_4));
  __pyx_t_4 = 0;

  /* "openpiv_SP/src/lib.pyx":92
 * 
 *     # number of NaN elements
 *     n_nans = len(inans)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_11 = PyObject_Length(((PyObject *)__pyx_v_inans)); if (unlikely(__pyx_t_11 == ((Py_ssize_t)-1))) __PYX_ERR(0, 92, __pyx_L1_error)
  __pyx_v_n_nans = __pyx_t_11;

  /* "openpiv_SP/src/lib.pyx":95
 * 
 *     # arrays which contain replaced values to check for convergence
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_n_nans); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_replaced_new.rcbuffer->pybuffer, (PyObject*)__pyx_t_17, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_n_nans); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_DTYPEf); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_replaced_old.rcbuffer->pybuffer, (PyObject*)__pyx_t_18, &__Pyx_TypeInfo_nn___pyx_t_10openpiv_SP_3lib_DTYPEf_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_18 = 0;
  __pyx_v_replaced_old = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "openpiv_SP/src/lib.pyx":99
 * 
 *     # depending on kernel type, fill kernel array
 *     if method == 'localmean':             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_19 = (__Pyx_PyString_Equals(__pyx_v_method, __pyx_n_s_localmean, Py_EQ)); if (unlikely(__pyx_t_19 < 0)) __PYX_ERR(0, 99, __pyx_L1_error)
  __pyx_t_20 = (__pyx_t_19 != 0);
  if (__pyx_t_20) {

    /* "openpiv_SP/src/lib.pyx":100
 *     # depending on kernel type, fill kernel array
 *     if method == 'localmean':
 *         for i in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *             for j in range(2*kernel_size+1):
 ...
 * 
 */
      __pyx_t_23 = ((2 * __pyx_v_kernel_size) + 1);
      __pyx_t_24 = __pyx_t_23;
      for (__pyx_t_25 = 0; __pyx_t_25 < __pyx_t_24; __pyx_t_25+=1) {
        __pyx_v_j = __pyx_t_25;

        /* "openpiv_SP/src/lib.pyx":102
 *         for i in range(2*kernel_size+1):
 *             for j in range(2*kernel_size+1):
 *                 kernel[i,j] = 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_27, __pyx_pybuffernd_kernel.diminfo[1].strides) = 1.0;
      }
    }
 ...
 *             for j in range(2*kernel_size+1):
 */
  __pyx_t_20 = (__Pyx_PyString_Equals(__pyx_v_method, __pyx_n_s_disk, Py_EQ)); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 104, __pyx_L1_error)
  __pyx_t_19 = (__pyx_t_20 != 0);
  if (__pyx_t_19) {

    /* "openpiv_SP/src/lib.pyx":105
 * 
 *     elif method == 'disk':
 *         for i in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *             for j in range(2*kernel_size+1):
 ...
 *                 else:
 */
        __pyx_t_19 = ((pow(((double)(__Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_i)), 2) + __Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_j)), 2))), 0.5) <= __pyx_v_kernel_size) != 0);
        if (__pyx_t_19) {

          /* "openpiv_SP/src/lib.pyx":108
 *             for j in range(2*kernel_size+1):
 *                 if ((kernel_size-i)**2 + (kernel_size-j)**2)**0.5 <= kernel_size:
 *                     kernel[i,j] = 1.0             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_kernel.diminfo[1].strides) = 1.0;
 ...
 */
        /*else*/ {
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_kernel.diminfo[1].strides) = 0.0;
        }
        __pyx_L14:;
      }
    }
 ...
 *             for j in range(2*kernel_size+1):
 */
  __pyx_t_19 = (__Pyx_PyString_Equals(__pyx_v_method, __pyx_n_s_distance, Py_EQ)); if (unlikely(__pyx_t_19 < 0)) __PYX_ERR(0, 112, __pyx_L1_error)
  __pyx_t_20 = (__pyx_t_19 != 0);
  if (likely(__pyx_t_20)) {

    /* "openpiv_SP/src/lib.pyx":113
 * 
 *     elif method == 'distance':
 *         for i in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 *             for j in range(2*kernel_size+1):
 ...
 *                 else:
 */
        __pyx_t_20 = ((pow(((double)(__Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_i)), 2) + __Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_j)), 2))), 0.5) <= __pyx_v_kernel_size) != 0);
        if (__pyx_t_20) {

          /* "openpiv_SP/src/lib.pyx":116
 *             for j in range(2*kernel_size+1):
 *                 if ((kernel_size-i)**2 + (kernel_size-j)**2)**0.5 <= kernel_size:
 *                     kernel[i,j] = kernel[i,j] = -1*(((kernel_size-i)**2 + (kernel_size-j)**2)**0.5 - ((kernel_size)**2 + (kernel_size)**2)**0.5)             # <<<<<<<<<<<<<<
 *                 else:
 *                     kernel[i,j] = 0.0
 */
          __pyx_t_32 = (-1.0 * (pow(((double)(__Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_i)), 2) + __Pyx_pow_long(((long)(__pyx_v_kernel_size - __pyx_v_j)), 2))), 0.5) - pow(((double)(__Pyx_pow_long(((long)__pyx_v_kernel_size), 2) + __Pyx_pow_long(((long)__pyx_v_kernel_size), 2))), 0.5)));
          __pyx_t_33 = __pyx_v_i;
          __pyx_t_34 = __pyx_v_j;
          *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_34, __pyx_pybuffernd_kernel.diminfo[1].strides) = __pyx_t_32;
          __pyx_t_35 = __pyx_v_i;
          __pyx_t_36 = __pyx_v_j;
          *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_36, __pyx_pybuffernd_kernel.diminfo[1].strides) = __pyx_t_32;
 ...
 */
        /*else*/ {
          ...
          *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_37, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_38, __pyx_pybuffernd_kernel.diminfo[1].strides) = 0.0;
        }
        __pyx_L19:;
      }
    }
 ...
 */
  /*else*/ {
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 120, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  for (__pyx_t_39 = 0; __pyx_t_39 < __pyx_t_25; __pyx_t_39+=1) {
    __pyx_v_it = __pyx_t_39;

    /* "openpiv_SP/src/lib.pyx":127
 * 
 *         # for each NaN element
 ...
 *             j = jnans[k]
 */
    __pyx_t_11 = __pyx_v_n_nans;
    __pyx_t_40 = __pyx_t_11;
    for (__pyx_t_41 = 0; __pyx_t_41 < __pyx_t_40; __pyx_t_41+=1) {
      __pyx_v_k = __pyx_t_41;

      /* "openpiv_SP/src/lib.pyx":128
 *         # for each NaN element
 *         for k in range(n_nans):
 *             i = inans[k]             # <<<<<<<<<<<<<<
 *             j = jnans[k]
 ...
 */
      ...
      __pyx_v_i = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEi_t *, __pyx_pybuffernd_inans.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_inans.diminfo[0].strides));

      /* "openpiv_SP/src/lib.pyx":129
 *         for k in range(n_nans):
 *             i = inans[k]
 *             j = jnans[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_j = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEi_t *, __pyx_pybuffernd_jnans.rcbuffer->pybuffer.buf, __pyx_t_43, __pyx_pybuffernd_jnans.diminfo[0].strides));

      /* "openpiv_SP/src/lib.pyx":132
 * 
 *             #init to 0.0
 *             replaced_new[k] = 0.0             # <<<<<<<<<<<<<<
 *             n = 0.0
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_replaced_new.diminfo[0].strides) = 0.0;

      /* "openpiv_SP/src/lib.pyx":133
 *             #init to 0.0
 *             replaced_new[k] = 0.0
 *             n = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_21 = ((2 * __pyx_v_kernel_size) + 1);
      __pyx_t_22 = __pyx_t_21;
      for (__pyx_t_45 = 0; __pyx_t_45 < __pyx_t_22; __pyx_t_45+=1) {
        __pyx_v_I = __pyx_t_45;

        /* "openpiv_SP/src/lib.pyx":137
 *             # loop over the kernel
 *             for I in range(2*kernel_size+1):
 *                 for J in range(2*kernel_size+1):             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_23 = ((2 * __pyx_v_kernel_size) + 1);
        __pyx_t_24 = __pyx_t_23;
        for (__pyx_t_46 = 0; __pyx_t_46 < __pyx_t_24; __pyx_t_46+=1) {
          __pyx_v_J = __pyx_t_46;

          /* "openpiv_SP/src/lib.pyx":140
 * 
 *                     # if we are not out of the boundaries
 ...
 * 
 */
          __pyx_t_19 = ((((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size) < (__pyx_v_array->dimensions[0])) != 0);
          if (__pyx_t_19) {
          } else {
 ...
 */
            __pyx_t_19 = ((((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size) < (__pyx_v_array->dimensions[1])) != 0);
            if (__pyx_t_19) {
            } else {
              __pyx_t_20 = __pyx_t_19;
              goto __pyx_L32_bool_binop_done;
            }
            __pyx_t_19 = ((((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size) >= 0) != 0);
            __pyx_t_20 = __pyx_t_19;
            __pyx_L32_bool_binop_done:;
            if (__pyx_t_20) {

              /* "openpiv_SP/src/lib.pyx":144
 * 
 *                             # if the neighbour element is not NaN itself.
 ...
 */
              ...
              __Pyx_GOTREF(__pyx_t_2);
              __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_isnan); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 144, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_1);
              __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
              __pyx_t_47 = ((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size);
              __pyx_t_48 = ((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size);
              __pyx_t_2 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_array.rcbuffer->pybuffer.buf, __pyx_t_47, __pyx_pybuffernd_array.diminfo[0].strides, __pyx_t_48, __pyx_pybuffernd_array.diminfo[1].strides))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 144, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_2);
              __pyx_t_3 = NULL;
              if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_1))) {
              ...
              __Pyx_GOTREF(__pyx_t_4);
              __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
              __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_t_4); if (unlikely(__pyx_t_20 < 0)) __PYX_ERR(0, 144, __pyx_L1_error)
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
              __pyx_t_19 = ((!__pyx_t_20) != 0);
              if (__pyx_t_19) {

                /* "openpiv_SP/src/lib.pyx":147
 * 
 *                                 # do not bother with 0 kernel values
 *                                 if kernel[I, J] != 0:             # <<<<<<<<<<<<<<
 * 
 ...
 */
                ...
                __pyx_t_19 = (((*__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_49, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_50, __pyx_pybuffernd_kernel.diminfo[1].strides)) != 0.0) != 0);
                if (__pyx_t_19) {

                  /* "openpiv_SP/src/lib.pyx":150
 * 
 *                                     # convolve kernel with original array
 ...
 */
                  ...
                  __pyx_t_52 = ((__pyx_v_i + __pyx_v_I) - __pyx_v_kernel_size);
                  __pyx_t_53 = ((__pyx_v_j + __pyx_v_J) - __pyx_v_kernel_size);
                  __pyx_t_54 = __pyx_v_I;
                  __pyx_t_55 = __pyx_v_J;
                  __pyx_t_56 = __pyx_v_k;
                  *__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_56, __pyx_pybuffernd_replaced_new.diminfo[0].strides) = ((*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_51, __pyx_pybuffernd_replaced_new.diminfo[0].strides)) + ((*__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_array.rcbuffer->pybuffer.buf, __pyx_t_52, __pyx_pybuffernd_array.diminfo[0].strides, __pyx_t_53, __pyx_pybuffernd_array.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_54, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_55, __pyx_pybuffernd_kernel.diminfo[1].strides))));

                  /* "openpiv_SP/src/lib.pyx":151
 *                                     # convolve kernel with original array
 *                                     replaced_new[k] = replaced_new[k] + array[i+I-kernel_size, j+J-kernel_size]*kernel[I, J]
 *                                     n = n + kernel[I,J]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                  ...
                  __pyx_v_n = (__pyx_v_n + (*__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_57, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_58, __pyx_pybuffernd_kernel.diminfo[1].strides)));
 ...
 */
        ...
        __pyx_t_60 = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_59, __pyx_pybuffernd_replaced_new.diminfo[0].strides));
        if (unlikely(__pyx_v_n == 0)) {
          PyErr_SetString(PyExc_ZeroDivisionError, "float division");
          __PYX_ERR(0, 156, __pyx_L1_error)
        }
        __pyx_t_61 = __pyx_v_k;
        *__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_61, __pyx_pybuffernd_replaced_new.diminfo[0].strides) = (__pyx_t_60 / __pyx_v_n);
 ...
 */
      /*else*/ {
        ...
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_nan); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 158, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_60 = __pyx_PyFloat_AsDouble(__pyx_t_1); if (unlikely((__pyx_t_60 == ((npy_double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 158, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_62 = __pyx_v_k;
        *__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_62, __pyx_pybuffernd_replaced_new.diminfo[0].strides) = __pyx_t_60;
      }
      __pyx_L36:;
    }

    /* "openpiv_SP/src/lib.pyx":161
 * 
 *         # bulk replace all new values in array
 *         for k in range(n_nans):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_66 = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEi_t *, __pyx_pybuffernd_inans.rcbuffer->pybuffer.buf, __pyx_t_64, __pyx_pybuffernd_inans.diminfo[0].strides));
      __pyx_t_67 = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEi_t *, __pyx_pybuffernd_jnans.rcbuffer->pybuffer.buf, __pyx_t_65, __pyx_pybuffernd_jnans.diminfo[0].strides));
      *__Pyx_BufPtrStrided2d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_array.rcbuffer->pybuffer.buf, __pyx_t_66, __pyx_pybuffernd_array.diminfo[0].strides, __pyx_t_67, __pyx_pybuffernd_array.diminfo[1].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_63, __pyx_pybuffernd_replaced_new.diminfo[0].strides));
    }

    /* "openpiv_SP/src/lib.pyx":166
 *         # check if mean square difference between values of replaced
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_mean); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = PyNumber_Subtract(((PyObject *)__pyx_v_replaced_new), ((PyObject *)__pyx_v_replaced_old)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_3 = PyNumber_Power(__pyx_t_4, __pyx_int_2, Py_None); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyFloat_FromDouble(__pyx_v_tol); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_19 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_19 < 0)) __PYX_ERR(0, 166, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (__pyx_t_19) {

      /* "openpiv_SP/src/lib.pyx":167
 *         #elements is below a certain tolerance
 *         if np.mean((replaced_new-replaced_old)**2) < tol:
 *             break             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_old.rcbuffer->pybuffer.buf, __pyx_t_69, __pyx_pybuffernd_replaced_old.diminfo[0].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_10openpiv_SP_3lib_DTYPEf_t *, __pyx_pybuffernd_replaced_new.rcbuffer->pybuffer.buf, __pyx_t_68, __pyx_pybuffernd_replaced_new.diminfo[0].strides));
      }
    }
  }
  __pyx_L21_break:;

  /* "openpiv_SP/src/lib.pyx":172
 *                 replaced_old[l] = replaced_new[l]
 * 
 *     return array             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_inans.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_iter_seeds.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_jnans.rcbuffer->pybuffer);
  ...
  __Pyx_XDECREF((PyObject *)__pyx_v_iter_seeds);
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "lib",
    __pyx_k_A_module_for_various_utilities_a, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_inans, __pyx_k_inans, sizeof(__pyx_k_inans), 0, 0, 1, 1},
  {&__pyx_n_s_int, __pyx_k_int, sizeof(__pyx_k_int), 0, 0, 1, 1},
  {&__pyx_n_s_isnan, __pyx_k_isnan, sizeof(__pyx_k_isnan), 0, 0, 1, 1},
  {&__pyx_n_s_it, __pyx_k_it, sizeof(__pyx_k_it), 0, 0, 1, 1},
  {&__pyx_n_s_iter_seeds, __pyx_k_iter_seeds, sizeof(__pyx_k_iter_seeds), 0, 0, 1, 1},
  {&__pyx_n_s_j, __pyx_k_j, sizeof(__pyx_k_j), 0, 0, 1, 1},
  {&__pyx_n_s_jnans, __pyx_k_jnans, sizeof(__pyx_k_jnans), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_n_nans, __pyx_k_n_nans, sizeof(__pyx_k_n_nans), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_openpiv_SP_lib, __pyx_k_openpiv_SP_lib, sizeof(__pyx_k_openpiv_SP_lib), 0, 0, 1, 1},
  {&__pyx_kp_s_openpiv_SP_src_lib_pyx, __pyx_k_openpiv_SP_src_lib_pyx, sizeof(__pyx_k_openpiv_SP_src_lib_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_range, __pyx_k_range, sizeof(__pyx_k_range), 0, 0, 1, 1},
  {&__pyx_n_s_replace_nans, __pyx_k_replace_nans, sizeof(__pyx_k_replace_nans), 0, 0, 1, 1},
  {&__pyx_n_s_replaced_new, __pyx_k_replaced_new, sizeof(__pyx_k_replaced_new), 0, 0, 1, 1},
  {&__pyx_n_s_replaced_old, __pyx_k_replaced_old, sizeof(__pyx_k_replaced_old), 0, 0, 1, 1},
 ...
 *     # make several passes
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_method_not_valid_Should_be_one_o); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 120, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__9 = PyTuple_Pack(21, __pyx_n_s_array, __pyx_n_s_max_iter, __pyx_n_s_tol, __pyx_n_s_kernel_size, __pyx_n_s_method, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_I, __pyx_n_s_J, __pyx_n_s_it, __pyx_n_s_k, __pyx_n_s_l, __pyx_n_s_n, __pyx_n_s_kernel, __pyx_n_s_inans, __pyx_n_s_jnans, __pyx_n_s_iter_seeds, __pyx_n_s_n_nans, __pyx_n_s_replaced_new, __pyx_n_s_replaced_old, __pyx_n_s_x); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(5, 0, 21, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_openpiv_SP_src_lib_pyx, __pyx_n_s_replace_nans, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("lib", __pyx_methods, __pyx_k_A_module_for_various_utilities_a, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_openpiv_SP__lib) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "openpiv_SP.lib")) {
      if (unlikely(PyDict_SetItemString(modules, "openpiv_SP.lib", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPEf, __pyx_t_2) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "openpiv_SP/src/lib.pyx":9
 * DTYPEf = np.float
 * ctypedef np.float_t DTYPEf_t
 * DTYPEi = np.int             # <<<<<<<<<<<<<<
 * ctypedef np.int_t DTYPEi_t
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10openpiv_SP_3lib_1replace_nans, NULL, __pyx_n_s_openpiv_SP_lib); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_replace_nans, __pyx_t_1) < 0) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "openpiv_SP/src/lib.pyx":1
 * """A module for various utilities and helper functions"""             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init openpiv_SP.lib", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init openpiv_SP.lib");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
